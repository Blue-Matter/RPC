...
tsplot<-function(x,yrs,xlab="",ylab="",zeroyint=T,cols=list(colm="dark blue", col50='light blue', col90='#60859925')){
...
hist_bio<-function(OBJs){
  ...
  tsplot(x=log(MSEhist@TSdata$RecDev[,1:(MSEhist@OM@nyears+MSEhist@OM@maxage-1)]), yrs,
