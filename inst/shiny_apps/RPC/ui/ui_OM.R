tabsetPanel(id="OM_hist", selected=1,
            ...
            tabPanel(h5("Future recruitment strength"),
                     p("The top row of figure shows the median (with 50% and 90% confidence intervals) of historical and projected log-recruitment deviations from the stock-recruit relationship.
                       The bottom row plots the annual mean deviation (in normal space). Thus, a stationary mean around one implies average productivity specified bt the stock-recruit relationship,
            ...
            tabPanel(h5("Spatial"),
                     p("Multiple-area spatial operating models can be used. Although a default 2-area model is generated, a single-area (no spatial dynamics) model is effective generated by setting all these parameters to 0.5."),
