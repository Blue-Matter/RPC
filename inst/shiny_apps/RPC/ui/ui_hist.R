                     ...
                     tabsetPanel(id = "Exploit", selected = 1,
                                 tabPanel(HTML("<h5>F<sub>MSY</sub></h5>"),
                                          div(style = "overflow-y:scroll; height:520px",
                                              ...
                                              HTML("<p>Use of MSY-based reference points implies the social choice of optimal yield as a management objective (<a href=\"Sainsbury2008_refPts.pdf\">Sainsbury 2008</a>). Typically,
                                                    a conservative limit reference point for fishing mortality should not exceed F<sub>MSY</sub> (<a href=\"https://doi.org/10.1006/jmsc.1999.0546\">Restrepo and Powers 1999</a>).</p>"),
                                 ...
                                 tabPanel(HTML("<h5>F<sub>med</sub></h5>"),
                                          div(style = "overflow-y:scroll; height:520px",
                                              HTML("<p><a href=\"https://doi.org/10.1139/f87-110\">Sissenwine and Shepherd (1987)</a> introduced the concept of average replacement when the stock-recruit relationship is indeterminate, for example, the stock-recruit pairs imply a linear relationship with no compensation in recruitment.
                                 ...
                                 tabPanel(h5("Spawning potential ratio (SPR)"),
                                          ...
                                          the reduction in spawning output relative to unfished conditions, is more robust in accounting for all these processes."),
                                              HTML("<p>SPR is also frequently used when it is desirable to avoid MSY-based reference point, for example, when there is high uncertainty about the stock-recruit relationship.
                                                Typically, SPR reference points have been established between 0.3 - 0.6, with higher values used for lower productivity stocks (<a href=\"https://doi.org/10.1006/jmsc.1999.0546\">Restrepo and Powers 1999</a>; <a href=\"Sainsbury2008_refPts.pdf\">Sainsbury 2008</a>).</p>"),
